...
@interface ZKentertainmentViewController ()<CLLocationManagerDelegate,MONActivityIndicatorViewDelegate,UIWebViewDelegate,UITableViewDataSource,UITableViewDelegate>
{
...
@implementation ZKentertainmentViewController
...
-(void)viewOne
{
    ...
    
    {
        ...
        exponentLabel.text = [NSString stringWithFormat:@"%0.1ld分",(long)oneMode.exponent.integerValue];
...
-(void)enterClick
{
    ...
    [[BaiduMobStat defaultStat] logEvent:@"share_recreation" eventLabel:@"分享娱乐列表"];
...
-(void)enterClick2
{
    ...
    [[BaiduMobStat defaultStat] logEvent:@"collect_recreation" eventLabel:@"我的收藏-景区"];
