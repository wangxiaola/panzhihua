...
#import "RWWHttpRequestTool.h"

@implementation RWWHttpRequestTool
//数据请求
...
+(void)PostRequestWithUrl:(NSString *)url prama:(NSDictionary *)dic success:(void(^)(id response))success fail:(void(^)(id response))fail{
    ...
    [manager POST:url parameters:dic success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        NSDictionary *dataDic=[NSJSONSerialization JSONObjectWithData:operation.responseData options:NSJSONReadingAllowFragments error:nil];
        success(dataDic);
...
//       添加要上传的文件
        [formData appendPartWithFileData:imageData name:@"服务器放图片的参数名（Key）" fileName:@"图片名字.png" mimeType:@"image/jpeg.png"];
