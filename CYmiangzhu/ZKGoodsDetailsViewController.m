...
@interface ZKGoodsDetailsViewController ()<CLLocationManagerDelegate,MONActivityIndicatorViewDelegate,UIWebViewDelegate,UITableViewDataSource,UITableViewDelegate>
{
...
@implementation ZKGoodsDetailsViewController
...
-(void)viewOne
{
    ...
    
    {
        ...
        foodView =[[UIView alloc]initWithFrame:CGRectMake(0, imageHeghit+60+40+10+10, kDeviceWidth, 100)];
        ...
        viewOne =imageHeghit+60+40+10+10+40+20;
...
-(void)enterClick
{
    ...
    [[BaiduMobStat defaultStat] logEvent:@"share_dining" eventLabel:@"分享美食列表"];
...
-(void)enterClick2
{
    [[BaiduMobStat defaultStat] logEvent:@"collect_dining" eventLabel:@"收藏美食列表"];
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        viewOne =imageHeghit+190+webHeight;
