...
- (void)createToolbar
{
    ...
    if (self.isDelete ==NO){
        ...
        UIButton *btu =[[UIButton alloc]initWithFrame:CGRectMake(self.view.frame.size.width-64, self.view.frame.size.height-34, 48, 27)];

        [btu setImage:[UIImage imageNamed:@"remove_0"] forState:UIControlStateNormal];
        [btu setImage:[UIImage imageNamed:@"remove_1"] forState:UIControlStateHighlighted];
