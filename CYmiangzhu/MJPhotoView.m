...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame])) {
        ...
        titilabel =[[UILabel alloc]initWithFrame:CGRectMake(20,kDeviceHeight/3+50, kDeviceWidth-40, 60)];
        titilabel.font =[UIFont systemFontOfSize:12];
        titilabel.numberOfLines = 3;
        titilabel.textColor =[UIColor whiteColor];
        titilabel.textAlignment =NSTextAlignmentCenter;
        [_imageView addSubview:titilabel];
        // 进度条
...
- (void)showImage
{
    ...
    if (self.photo.titis) {
        ...
        titilabel.text = self.photo.titis;
    }
