...
@interface ZKCommentViewController ()<UITextViewDelegate,UIKeyboardViewControllerDelegate>
{
    evaluat _evaluat;
    RatingBar *pjRatingBar;
    ZKscenicSpotList *data;
...
@implementation ZKCommentViewController
...
-(void)initView
{
   ...
   UIView* pingjiaView =[[UIView alloc]initWithFrame:CGRectMake(0, 10+64, kDeviceWidth, 45+160)];
    ...
    pjRatingBar.rating = data.exponent;
    ...
    _pjPriceLabel.text =[NSString stringWithFormat:@"%.1f分",data.exponent];
