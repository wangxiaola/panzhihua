...
@interface CXMultidateCalendarView()
@property (strong, nonatomic)CXCalendarCellView *lastCalendarCellView;
@end
...
- (void) touchedCellView: (CXCalendarCellView *) cellView {
    if (cellView == _lastCalendarCellView) {
        return;
    }
    
    _lastCalendarCellView = cellView;
